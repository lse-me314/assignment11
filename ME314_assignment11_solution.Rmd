...
2. Use the functions in the `quanteda` package to turn this data into a `corpus` object. Attach the relevant metadata as `docvars`.
...
3. Describe a few topics as you see them.  Is there a "scary movie" topic?  Is there a "science fiction" topic?  
